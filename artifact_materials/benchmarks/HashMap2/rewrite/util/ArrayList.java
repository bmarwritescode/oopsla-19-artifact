...
class ArrayList<E> {
    ...
    rewrite int size(ArrayList<E> remove!(ArrayList a, int i)) {
	return size(a)-1;
    }
    ...
    rewrite E get(ArrayList<E> remove!(ArrayList a, int j),
		  int i) {
	return i==j ? null : get(a, i);
    }
    
    rewrite E get(ArrayList<E> add!(ArrayList a, E e1), int i) {
